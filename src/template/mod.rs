    ...
    fn default() -> Self {
        Self {
            ...
            resources: vec![
                ...
                resource::GenericResource::Remote { url: "".into(), sha512: None, archive: Some(resource::ArchiveInfo { inner_path: path::PathBuf::from("server.properties"), archive_format: crate::resources::ArchiveFormat::Zip }), template_path: path::PathBuf::from("server.properties") },
            ],
        }
    }
}
